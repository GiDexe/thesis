...
cat("Hour:", format(Sys.time(), "%H:%M"), "\n")
cat("TOT TIME:", round(as.numeric(difftime(Sys.time(), t_start_37, units = "hours")), 1), "ore\n")
cat("========================================\n")
...
for (iso in c("37001", "45001")) {
  ...
  cat("  Robust Edges (>40%):", sum(stability > 0.4), "\n")
}
...
saveRDS(W_best_37001, file = "data/output_data/W_best_37001.rds")
saveRDS(W_best_45001, file = "data/output_data/W_best_45001.rds")
saveRDS(rho_best_37001, file = "data/output_data/rho_best_37001.rds")
saveRDS(rho_best_45001, file = "data/output_data/rho_best_45001.rds")
...
saveRDS(bic_table, file = "data/output_data/bic_table.rds")

cat("\n=== BIC TABLE (ordered, ISO 37001) ===\n")
print(bic_table)
...
cat("  bic_table.rds\n")
cat("  grid_search_ISO37001.RData  (all results)\n")
