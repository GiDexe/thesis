...
cat("ISO 37001 - N:", length(unique(data_37001_std$id)), 
    "T:", length(unique(data_37001_std$time)), "\n")
cat("  y: mean=", round(mean(data_37001_std$y), 3), 
    "sd=", round(sd(data_37001_std$y), 3), "\n")
cat("ISO 45001 - N:", length(unique(data_45001_std$id)), 
    "T:", length(unique(data_45001_std$time)), "\n")
cat("  y: mean=", round(mean(data_45001_std$y), 3), 
...
for (label in c("ISO37001_standardised", "ISO45001_standardised")) {
  load(paste0("grid_search_", label, ".RData"))
